...
if ($showSlider < 2) {
			...
			<?php while ($tbQuery->have_posts()) : $tbQuery->the_post(); ?>
	        	...
	        	<div class="slide">
	                ...
	                <a href="<?php echo $tbURL; ?>" title="<?php echo $postTitle; ?>">
						<?php echo get_the_post_thumbnail($post->ID, 'gallerySlider', array('alt' => $postTitle)); ?>
	                </a>
	            </div>
			<?php endwhile; ?>
		</div>
	...
	<?php
		...
		$useEasingEffect = get_option('tb_gallery_slider_use_easing', DEFAULT_GALLERY_SLIDER_USE_EASING);
