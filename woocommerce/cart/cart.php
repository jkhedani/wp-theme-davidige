			...
			<td colspan="6" class="actions">
				...
				<?php if ( get_option( 'woocommerce_enable_coupons' ) == 'yes' && get_option( 'woocommerce_enable_coupon_form_on_cart' ) == 'yes') { ?>
					<div class="coupon">
						...
						<label for="coupon_code"><?php _e('Coupon', 'woocommerce'); ?>:</label> <input name="coupon_code" class="input-text" id="coupon_code" value="" /> <input type="submit" class="tinyButton roundButton" name="apply_coupon" value="<?php _e('Apply Coupon', 'woocommerce'); ?>" />
				...
				<?php } ?>
				 ...
				 <a href="<?php echo esc_url( $woocommerce->cart->get_checkout_url() ); ?>" class="checkout-button tinyButton roundButton alt right"><?php _e('Proceed to Checkout &rarr;', 'woocommerce'); ?></a> <input type="submit" class="tinyButton roundButton right" name="update_cart" value="<?php _e('Update Cart', 'woocommerce'); ?>" />
